...
class PortfolioEnv(gym.Env):
    ...
    def __init__(self,
        ...
        self.action_space = gym.spaces.Box(
            0.0, 1.0, shape=(nb_assets + 1,), dtype=np.float32)
    ...
    def step(self, action):
        ...
        # Ensure action is float32 for action_space.contains check
        ...
        terminated = done1 or done2
        truncated = False
        return {'history': history, 'weights': weights}, reward, terminated, truncated, info
    ...
    def reset(self, seed=None, options=None):
        ...
        # Get initial observation WITHOUT calling step()
        # This avoids potential look-ahead bias
        history, y1, done = self.src._step()
        ...
        obs = {'history': history, 'weights': self.sim.w0}
        info = {"portfolio_value": self.sim.p0}
        return obs, info
